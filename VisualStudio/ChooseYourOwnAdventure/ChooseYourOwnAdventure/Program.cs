...
namespace ChooseYourOwnAdventure
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Start game by printing story
            Console.WriteLine("It begins on a cold rainy night. You're sitting " +
                "in your room and hear a noise coming from down the hall. " +
            ...
            else if (noiseChoice == "YES")
            {
                ...
                if (doorChoice == "KNOCK")
                {
                    Console.WriteLine("A voice behind the door speaks. It says \"Answer this ridde:" +
